...
export const loadSprites = (scene) => {
    ...
    //boss
    scene.load.spritesheet('boss1', 'assets/img/enemys/boss1.png', {frameHeight: 266,frameWidth: 400})
    ...
    scene.load.image('bullet6', 'assets/img/objects/bullet6.png')
    scene.load.image('bullet7', 'assets/img/objects/bullet7.png')
    scene.load.image('bullet8', 'assets/img/objects/bullet8.png')
